...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 flex-title-table">
            <h4 class="m-0 font-weight-bold text-primary">Voluntárioss</h4>
            ...
            <button name="cadastroPessoa" type="button"  class="btn btn-primary btn-icon-split font-button-add" data-bs-toggle="modal" data-bs-target="#cadastroPessoa">
                ...
                <span class="text">
                    <font style="vertical-align: inherit;">
                        <font style="vertical-align: inherit;">Novo Voluntário</font>
                    </font>
                </span>
            </button>
        ...
        $i = 1;
        $query = "SELECT * FROM pessoas WHERE pessoa_status = 'Confirmado' AND pessoa_tipo = 'Voluntario' OR  pessoa_status = 'Pendente' AND pessoa_tipo = 'Voluntario'";
                    ...
                    <tbody>
                        ...
                        ?>
                                ...
                                <tr>
                                    ...
                                    <td><small class="small-detalhes"><?php echo $row['pessoa_area'] ?></small><br></td>
                                    <td>
        ...
        <div class="container">
            ...
            <div class="modal fade" id="cadastroPessoa" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="staticBackdropLabel">Cadastrar Voluntário</h5>
                        </div>
                        <div class="modal-body">
                            ...
                            <form method="POST" action="../admin/acoes/adicionar.php">
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <label>Nome</label>
                                        <input type="hidden" class="form-control form-control-user" name="pessoa_tipo" value="Voluntario" required>
                                ...
                                <div class="form-group row">
                                    <label for="recipient-name" class="col-form-label">Área para atuar</label>
                                    <!-- <input name="status" type="text" class="form-control" id="pessoa_status"> -->
                                    <select name="pessoa_area" class="form-control" aria-label="Selecione Área para atuar">
                                        <option name="pessoa_area" value="Adoração">Adoração</option>
                                        <option name="pessoa_area" value="Comunhão">Comunhão</option>
                                        <option name="pessoa_area" value="Serviço">Serviço</option>
                                    </select>
                                </div>
